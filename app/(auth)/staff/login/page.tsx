  ...
  return (
    <Card className="w-full max-w-md mx-auto shadow-lg border-0">
      <CardHeader className="text-center">
        ...
        <p className="text-gray-600 mt-2">Access patient records and manage appointments</p>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div className="text-center text-sm text-gray-600">
            ...
            <Link href="/staff/register" className="text-green-600 hover:underline">
              Register here
            </Link>
          </div>

          <div className="text-center text-xs text-gray-500">
            Demo: Use staff@example.com / password
          </div>
        </form>
